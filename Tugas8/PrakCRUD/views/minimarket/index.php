...
<?php if(!empty($dataDeleted)): ?>
    ...
    <div style="text-align:center; margin-bottom:12px;">
        <form method="POST" action="?c=maintenance&a=autoDeleteOld" style="display:inline;">
            <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrf) ?>">
            <input type="hidden" name="days" value="30">
            <button class="button danger" type="submit" onclick="return confirm('Permanently delete items older than 30 days? This cannot be undone.')">Auto-Delete >30 days</button>
        </form>
    </div>
    <table>
        <tr>
